...
[![Solved.ac Profile](http://mazassuminda.wtf/api/v2/generate_badge?boj=hihyeon29)](https://solved.ac/hihyeon29/)
...
**Backend Engineer | Java/Spring Boot | Open to EU relocation**

- 🔭 Working on: Intelligent automation solutions using AI/LLM, Event-driven Microservices
- 📊 Stats: 5 years in Backend Development, Event-driven MSA
- 🌱 Learning: AWS Solutions Architect (studying for certification)
